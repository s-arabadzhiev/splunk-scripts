...
* **Automated OS User Management**
  Automatically checks for and creates the `splunk` system user with the correct home directory and shell.

* **Secure Credential Handling**
  Utilizes the `user-seed.conf` method to pre-set the Splunk `admin` password, bypassing the manual setup wizard.
...
* **Supported OS**
  Ubuntu 20.04/22.04+, RHEL/CentOS 8/9, or any Debian-based distribution.
